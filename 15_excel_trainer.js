...
7. ФАТАЛЬНАЯ ОШИБКА В "syntax": КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО писать текстовые пояснения аргументов (слова "число", "количество_разрядов", "диапазон", "условие", "range"). Пиши ТОЛЬКО реальные адреса ячеек и конкретные цифры!
ПРАВИЛЬНО: =${formulaName}(A1; 2) или =${formulaName}(B2:B10)
НЕПРАВИЛЬНО: =${formulaName}(число; количество_разрядов) или =${formulaName}(диапазон; условие)`;
        try {
